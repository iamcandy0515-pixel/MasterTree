...
class StatisticsViewModel extends ChangeNotifier {
  ...
  List<dynamic> get activeUsersList =>
      _users.where((dynamic u) => u['is_active_tab'] == true).toList();
  List<dynamic> get inactiveUsersList =>
      _users.where((dynamic u) => u['is_active_tab'] == false).toList();
  ...
  Future<void> loadStats() async {
    ...
    try {
      ...
      _users = List<dynamic>.from(data['activeUsers'] as Iterable? ?? <dynamic>[]);
    } catch (e) {
