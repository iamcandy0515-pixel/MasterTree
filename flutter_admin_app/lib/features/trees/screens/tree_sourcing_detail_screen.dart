...
class TreeSourcingDetailScreen extends StatefulWidget {
  ...
  @override
  State<TreeSourcingDetailScreen> createState() =>
      _TreeSourcingDetailScreenState();
}
    ...
    return [
      Padding(
        ...
        child: TextButton(
          ...
          style: TextButton.styleFrom(foregroundColor: NeoColors.acidLime),
          child: vm.isLoading
              ? const SizedBox(
                  width: 16,
                  height: 16,
