...
├── flutter_user_app/        # User-facing Flutter mobile app
├── flutter_admin_app/       # Admin Flutter mobile/web app
├── nodejs_admin_api/        # Backend API for administrative tasks
├── package.json             # Root workspace management
├── DEVELOPER_HANDBOOK.md    # Global developer guidelines
└── STYLE_GUIDE.md           # Unified design system & style guide
```
